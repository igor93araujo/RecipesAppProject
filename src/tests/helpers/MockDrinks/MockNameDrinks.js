...
const ocktailGlass = 'Cocktail glass';
const limeJuice = 'Lime juice';

export const mockNameDrinks = {
  drinks: [
    {
      idDrink: '11007',
      strDrink: 'Margarita',
